...
from posterization_old import detect_colors
from posterization_old import preprocess, rgb2hex, save_palette, get_matrix, save_cluster, save_json, get_cluster_data, data_score_mult
